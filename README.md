...
<details Reload maven><summary>Бонус темы для IntelliJ IDEA в стиле Visual Studio Code</summary><blockquote>

![BlackVSC-Demo.jpg](./Theme/BlackVSC-Demo.jpg)

**Черная тема для IntelliJ IDEA в стиле Visual Studio Code** ( [BlackVSC.icls](./Theme/BlackVSC.icls "скачать BlackVSC.icls") )

![WhiteVSC-Demo.jpg](./Theme/WhiteVSC-Demo.jpg)

**Белая тема для IntelliJ IDEA в стиле Visual Studio Code** ( [WhiteVSC.icls](./Theme/WhiteVSC.icls "скачать WhiteVSC.icls") )
